...
<div class="mt-3">
  ...
  <div class="d-flex align-items-center">
    <div class="form-group d-flex m-0">
      ...
      <div class="">
        <input type="text" class="form-control" id="empNameSei" ref="empNameSei" placeholder="社員名(姓)">
      </div>
    </div>
    <div class="form-group d-flex m-0 ml-2">
      <label for="empNameMei" class="col-form-label mr-2">名</label>
      <div class="">
        <input type="text" class="form-control" id="empNameMei" ref="empNameMei" placeholder="社員名(名)">
      </div>
    </div>
  ...
  <table class="table table-sm table-bordered text-center table-fixed">
    ...
    <tbody class="emp_list_wrap">
      <tr v-for="employee in employees">
        <td class="col-md-2" scope="row">@{{ employee.is_admin ? '◯' : '×' }}</th>
